...
const BASE_URL = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time value", "http://q-tap.hassan-tech.site/api/");
const BASE_URL_IMAGE = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time value", "http://q-tap.hassan-tech.site/");
const DASHBOARD_URL = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time value", "http://localhost:3001");
const CURRENT_URL = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : ("TURBOPACK compile-time value", "http://q-tap.hassan-tech.site/");
const egyptCities = [
    {
        name: "Cairo",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__adceae98._.js.map